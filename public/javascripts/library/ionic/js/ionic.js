 ...
 *
 * In some cases, third-party script/library may also be working with touch events which can interfere
 * with the tap system. For example, mapping script/library like Google or Leaflet Maps often implement
...
(function () {
    ...
    var Swiper = function (container, params, _scope, $compile) {
        ...
        s.classNames = [];
        /*=========================
          Dom script/library and plugins
          ===========================*/
    ...
    /*===========================
     Get Dom script/library
     ===========================*/
    var swiperDomPlugins = ['jQuery', 'Zepto', 'Dom7'];
    for (var i = 0; i < swiperDomPlugins.length; i++) {
    	if (window[swiperDomPlugins[i]]) {
    		addscript/libraryPlugin(window[swiperDomPlugins[i]]);
    	}
    }
    ...
    /*===========================
    Add .swiper plugin from Dom script/library
    ===========================*/
    function addscript/libraryPlugin(lib) {
