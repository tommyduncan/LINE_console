    ...
    sizeOf('./public/images/uploads/' + imageName, function (err, dimensions) {
        if (!err) {
            if (dimensions.width > 240 || dimensions.height > 240) {
                ...
                } else if (dimensions.width / dimensions.height < 1 && dimensions.height > 240) {
